...
class ClassificationResponse(BaseModel):
    choice: Literal[0, 1, -1] = Field(..., description="Classification choice: 0 for left, 1 for right, -1 for equal")
...
class Stage_2():
    def __init__(
        ...
        self.output_file       = self.s1_data_file.replace('_s1_', '_s2_')
    ...
    def evaluate(self):
        ...
        cprint(f"Accuracy: {accuracy:.4f}", 'green')
        ...
        eval_output_file = self.output_file.replace("_s2", "_s2_eval")
