...
from api_key import apiKey_openRouter_2 as API_KEY_REF
...
class Stage_1():
    def __init__(
        ...
        self.exp_task += "\n-----\n" + format_instructions
        # cprint(f"Experiment task: \n{self.exp_task}", 'yellow')
        # sys.exit()
    ...
    # ------------------ Multi Agent System ------------------
    def save_temp_result(self, agent_type: str, result: dict):
    ...
    def researcher_agent(self, step, image_parts):
        ...
        self.save_temp_result('researcher', research_result)
    ...
    def critic_agent(self, research_outputs):
        ...
        self.save_temp_result('critic', critic_result)
